function call_simulated_annealing_inc(algorithm, instances, TP_targets, ENV)
rng(42);
...
if nargin == 0
    ...
    algorithm = 'simulated-annealing-inc';
    ...
    for TP_target = TP_targets
        ...
        parfor k = 1:number_instances_total
            ...
            [c(1, 1:machines-1), q(1, 1:machines), TP, costs, counter_iterations, counter_evaluations, counter_problems] = ...
                optimize_simulated_annealing(machines, C_min, Q_min, C_max, Q_max, mu, p, gamma, TP_target, costs_buffers, costs_spares, C_min, Q_min, dir_local, filename_local, alg);
            time = toc();
