function call_enumeration(algorithm, instances, TP_targets, ENV)
rng(42);
    ...
    for TP_target = TP_targets
        ...
        parfor k = 1:number_instances_total
            ...
            [c(1, 1:machines-1), q(1, 1:machines), TP, costs, counter_iterations, counter_evaluations, counter_problems] = ...
                optimize_complete_enumeration(machines, C_min, Q_min, C_max, Q_max, mu, p, gamma, TP_target, costs_buffers, costs_spares, dir_local, filename_local);
            time = toc();
